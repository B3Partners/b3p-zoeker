...
INSERT INTO zoekconfiguratie (id,naam, featuretype, parentbron, parentzoekconfiguratie) VALUES (1,'Ro-online zoeker', 'app:Plangebied', 1, NULL);
...
INSERT INTO bron (id, naam, url, volgorde, gebruikersnaam, wachtwoord) VALUES (2, 'local', 'jdbc:postgresql://localhost:5432/zoeker', 2, 'postgres', 'postgres');
INSERT INTO zoekconfiguratie (id, naam, featuretype, parentbron, parentzoekconfiguratie) VALUES (3, 'Zoek eigenaar', 'planeigenaar', 2, NULL);
